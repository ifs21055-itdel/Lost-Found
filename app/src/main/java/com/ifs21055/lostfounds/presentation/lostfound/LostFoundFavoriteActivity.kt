package com.ifs21055.lostfounds.presentation.lostfound
...
import com.ifs21055.lostfounds.data.local.entity.DelcomLostFoundEntity
...
import com.ifs21055.lostfounds.helper.Utils.Companion.entitiesToResponses
...
import com.ifs21055.lostfounds.databinding.ActivityLostFoundFavoriteBinding
                ...
                object : LostFoundsAdapter.OnItemClickCallback {
                    override fun onCheckedChangeListener(
                        ...
                        val newLostFound = DelcomLostFoundEntity(
                            ...
                            status = if (lostfound.status.equals("found", ignoreCase = true)) {
                                "Found"
                            } else {
                                "Lost"
                            },
